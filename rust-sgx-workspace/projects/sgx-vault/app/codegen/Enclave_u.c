...
sgx_status_t vault_operation(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* sealed_request_buffer, size_t sealed_request_size, uint8_t* sealed_response_buffer, size_t sealed_response_capacity, size_t* sealed_response_used)
{
	sgx_status_t status;
	ms_vault_operation_t ms;
	ms.ms_sealed_request_buffer = sealed_request_buffer;
	ms.ms_sealed_request_size = sealed_request_size;
	ms.ms_sealed_response_buffer = sealed_response_buffer;
	ms.ms_sealed_response_capacity = sealed_response_capacity;
	ms.ms_sealed_response_used = sealed_response_used;
