...
pub extern "C" fn run_tests_ecall() -> usize {
    ...
    rsgx_unit_tests!(
        ...
        vault_operations::test_load_onfido_check::load_onfido_check_bad_pin,
        vault_operations::test_load_onfido_check::load_onfido_check_malformed_vault_id,
        vault_operations::test_load_onfido_check::load_onfido_check_not_found,
        vault_operations::test_load_onfido_check::load_onfido_check_works,
        ...
        vault_operations::test_save_onfido_check::save_onfido_check_bad_pin,
        vault_operations::test_save_onfido_check::save_onfido_check_malformed_vault_id,
        vault_operations::test_save_onfido_check::save_onfido_check_works,
        ...
        vault_operations::test_sign_transaction_xrpl::sign_transaction_empty,
