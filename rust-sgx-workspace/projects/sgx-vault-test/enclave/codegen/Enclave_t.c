...
static sgx_status_t SGX_CDECL sgx_run_tests_ecall(void* pms)
{
	...
	ms_run_tests_ecall_t __in_ms;
	if (memcpy_s(&__in_ms, sizeof(ms_run_tests_ecall_t), ms, sizeof(ms_run_tests_ecall_t))) {
